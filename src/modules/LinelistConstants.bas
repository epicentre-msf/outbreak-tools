...
Public Const C_sDictHeaderFormula       As String = "control details" 'Formulas for the variable
Public Const C_sDictHeaderChoices       As String = "choice_manual" 'Different types of choices for one variable
...
Public Const C_sFiltered                As String = "f" 'Just to know if we are on a filtered/Not filtered sheet or table
