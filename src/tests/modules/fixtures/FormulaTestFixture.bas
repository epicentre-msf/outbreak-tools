...
Public Function FormulaFunctionsValues() As Variant
    ...
    parts.Add "MEDIAN|MID|MIDB|MIN|MINA|MINUTE|MINVERSE|MIRR|MMULT|MOD|MODE|MODE.MULT|MODE.SNGL|MONTH|MROUND|MULTINOMIAL|MUNIT|N|NA|NEGBINOM.DIST|NEGBINOMDIST"
...
Public Function PrepareFormulaFixtureSheet(ByVal sheetName As String, _
    ...
    Set sh = TestHelpers.EnsureWorksheet(sheetName)
