...
- [DONE] Migrated CheckingOutput event/row markers to HiddenNames, guarded worksheet handler injection to run once, and left handler invocation to caller control.
