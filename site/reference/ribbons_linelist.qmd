...
## Refresh analyses {sec-refresh}

![Refresh analyses button](../reference/images/img-007-ll-refresh-analyses.png){fig-align="center"}

Hit the "Refresh analyses" button to update analyses on all [analyses sheets]((../getting_started/use_analyses_sheets.qmd)) in one go. You should use it whenever you entered new data or when you applied filters to existing data and want to see the analyses on this subset of data.^[Do not forget to remove the filters and refresh the analyses at the end to not be confused by the numbers in a couple of days]
