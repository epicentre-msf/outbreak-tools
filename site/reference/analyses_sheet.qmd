...
- a table to define a "Global Summary" section, containing general indicators
- a table to define analyses on single variables: "Univariate Analysis"
- a table to define analyses crossing two variables: "Bivariate Analysis"
- three tables to define time series and their graphs: "Time Series Analysis", "Labels for Time Series Graphs", "Graph on Time Series"
- two tables to define spatio-temporal analyses: "Specification for Spatio-Temporal Analysis", "Spatio-Temporal Analysis"
