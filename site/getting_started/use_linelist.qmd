---
title: "Get started with a linelist"
description: Learn the first steps to use an OBT linelist
---
...
3.	Some or all of the following [analyses sheets](../getting_started/use_analyses_sheets.qmd) containing basic exploration of data:  
