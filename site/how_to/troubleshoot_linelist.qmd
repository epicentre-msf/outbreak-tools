...
![](../how_to/images/img-008-troubleshooting.png){fig-align="center" height=100}
...
*My analyses sheets do not update after I enter data*
...
2. Hit **F9** in the patient data sheet make sure all formula are up-to-date
3. Hit the "Refresh analyses button" in the [OutbreakTools Menu](../reference/ribbons_linelist.qmd).
4. In the temporal analyses sheet and the spatio-temporal one, **select the unit you want to display**.
...
Read more about the [analyses sheets](../getting_started/use_analyses_sheets.qmd) in the linelist.
