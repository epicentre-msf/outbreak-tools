...
*The file is getting corrupted, things do not work properly anymore*
...
-	Did you send the data to the mail adress epi-data [at] epicentre.msf.org? Sharing a file with OneDrive does not work.
...
-	Was the OutbreakTool linelist Info sheet correctly filled? Scripts cannot compile the data if any of these are missing:
  - Organization
  - Country Name
